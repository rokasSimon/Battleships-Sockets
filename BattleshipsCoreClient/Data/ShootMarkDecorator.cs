...
{
    public class ShootMarkDecorator : ButtonDecorator
    {
        Button newBase;
        public ShootMarkDecorator(Button basee) : base(basee)
        {
            newBase = basee;
            ...
            SolidBrush semiTransBrush = new SolidBrush(Color.FromArgb(255, 255, 69, 0));
