...
{
    public class CruiserTank : Tank
    {
        public override TileType Type => TileType.CruiserTank;

        public int Size { get; set; }

        public CruiserTank(string name, int size, int max) : base(name, max)
        {
            Size = size;
        }
        ...
        public override List<Vec2> HoverTiles(Vec2 gridSize, Vec2 position)
        {
            ...
            var hoverTiles = new List<Vec2> { currentPosition };
